...
<body>
    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-4 "><button1 type="submit" class="btn btn-primary">Send Message</button1></div>
        ...
        <div class="container ">
            <div class="row">
                <div class="col-md-4 ">Section1</div>
                <div class="col-md-4 ">Section2</div>
                <div class="col-md-4 ">Section3</div>
            </div>
